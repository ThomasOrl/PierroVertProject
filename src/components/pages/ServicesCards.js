        ...
        <div className="grid grid-cols-1 my-10 mx-5 gap-20 grid-cols-medium grid-cols-large ">
          <div className="group h-96 w-80 [perspective:1000px] ">
            ...
            <div className="relative inset-x-0 bottom-0 flex justify-center mt-2">
              ...
              />
              <p className="text-black text-2xl">Elagage</p>
            </div>
          </div>
          <div className="group h-96 w-80 [perspective:1000px]">
            <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] xl:group-hover:[transform:rotateY(180deg)]">
            ...
            <div className="relative inset-x-0 bottom-0 flex justify-center mt-2">
              <AiFillPlusSquare
                ...
                className="text-green-600 mr-3 mt-1"
              />
              <p className="text-black text-2xl">Abattage</p>
            </div>
          </div>
          <div className="group h-96 w-80 [perspective:1000px]">
            <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] xl:group-hover:[transform:rotateY(180deg)]">
            ...
            <div className="relative inset-x-0 bottom-0 flex justify-center mt-2">
              <AiFillPlusSquare
                ...
                className="text-green-600 mr-3 mt-1"
              />
              <p className="text-black text-2xl">Entretien jardin</p>
            </div>
          </div>
          <div className="group h-96 w-80 [perspective:1000px]">
            <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] xl:group-hover:[transform:rotateY(180deg)]">
            ...
            <div className="relative inset-x-0 bottom-0 flex justify-center mt-2">
              <AiFillPlusSquare
                ...
                className="text-green-600 mr-3 mt-1"
              />
              <p className="text-black text-2xl">Tonte pelouse</p>
            </div>
          </div>
          <div className="group h-96 w-80 [perspective:1000px]">
            <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] xl:group-hover:[transform:rotateY(180deg)]">
            ...
            <div className="relative inset-x-0 bottom-0 flex justify-center mt-2">
              <AiFillPlusSquare
                ...
                className="text-green-600 mr-3 mt-1"
              />
              <p className="text-black text-2xl">Plantations</p>
            </div>
          </div>
          ...
          <div className="group h-96 w-80 [perspective:1000px]">
            ...
            <div className="relative inset-x-0 bottom-0 flex justify-center mt-2">
              <AiFillPlusSquare
                ...
                className="text-green-600 mr-3 mt-1"
              />
              <p className="text-black text-2xl">Aménagements</p>
            </div>
          </div>
        </div>
      </div>
